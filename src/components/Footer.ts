export default `<footer class="footer">
  {{> Link href="#" class="link footer-link" data-page="loginPage" text="Log in"}}
  {{> Link href="#" class="link footer-link" data-page="registrationPage" text="Sign up"}}
  ...
  {{> Link href="#" class="link footer-link" data-page="chatsPage" text="Chats"}}
  {{> Link href="#" class="link footer-link" data-page="chatsWithDialogPage" text="Chats with dialog"}}
</footer>`;
